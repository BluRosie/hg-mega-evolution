...
.org 0x0202990A // replace 44 with 84
    add r5, #0x84
...
.org 0x0202A032 // replace 44 with 84
    add r2, #0x84


// edits to GetSeenFlag

.org 0x0202A078 // replace 44 with 84
    add r1, #0x84


// edits to unknown function

.org 0x0202A0E6 // replace 44 with 84
    add r2, #0x84


// edits to SetMonSeen

.org 0x0202A3C2 // replace 44 with 84
    add r2, #0x84
...
.org 0x0202A414 // replace 44 with 84
    add r5, #0x84


// edits to SetMonCaught

.org 0x0202A494 // replace 44 with 84
    add r3, #0x84
